...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  useEffect(() => {
    ...
    if (isLoading || !config) {
      console.log('SEOHead early return - still loading or no config');
      return;
    }

    try {
      console.log('SEOHead starting configuration');
      ...
      const updateMetaTag = (name: string, content: string, property?: boolean) => {
        ...
        try {
          ...
          console.error('Error updating meta tag:', name, metaError);
        }
      };
      ...
      try {
        ...
        console.error('Error setting canonical URL:', canonicalError);
      }
      ...
      try {
        ...
        console.error('Error setting schema markup:', schemaError);
      }

      console.log('SEOHead completed successfully');
    } catch (error) {
      console.error('SEOHead critical error:', error);
    }
